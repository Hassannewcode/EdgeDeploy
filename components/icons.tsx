...
export const ExternalLinkIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-4.5 0V6m0 0h3.375M13.5 6l4.5 4.5" />
    </svg>
);
...
export const EdgeDeployLogo: React.FC<{ className?: string }> = ({ className }) => (
    <svg
        viewBox="0 0 24 24"
        fill="currentColor"
        className={className}
        xmlns="http://www.w3.org/2000/svg"
    >
        <path d="M2 14L12 9L22 14L12 19L2 14Z" />
        <path opacity="0.7" d="M2 10L12 5L22 10L12 15L2 10Z" />
        <path opacity="0.4" d="M2 6L12 1L22 6L12 11L2 6Z" />
    </svg>
);
...
export const NextjsIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 180 180" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M134.463 52.8125H112.425L72.4875 102.325V52.8125H60.15V123.188H72.4875L122.513 73.675V123.188H134.463V52.8125Z" className="fill-white dark:fill-black"/>
        <path d="M149 52.8125H137V123.188H149V52.8125Z" className="fill-white dark:fill-black"/>
    </svg>
);

export const CommerceIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 20C7.59 20 4 16.41 4 12C4 7.59 7.59 4 12 4C16.41 4 20 7.59 20 12C20 16.41 16.41 20 12 20Z" fill="currentColor"/>
        <path d="M13 11H14.5C15.33 11 16 11.67 16 12.5V12.5C16 13.33 15.33 14 14.5 14H13V15H11V14H10C9.17 14 8.5 13.33 8.5 12.5V12.5C8.5 11.67 9.17 11 10 11H11V9H13V11ZM11 13H13V12H11V13Z" fill="currentColor"/>
    </svg>
);
